...
player_text = tk.Label(frame, text="Player: ?", font=("Arial", 14), bg=BG_COLOR)
player_text.pack(pady=12)

computer_text = tk.Label(frame, text="Computer: ?", font=("Arial", 14), bg=BG_COLOR)
computer_text.pack(pady=12)

result_text = tk.Label(frame, text="Pick one!", font=("Arial", 16, "bold"), bg=BG_COLOR)
